...
export class KomojuCreditCardShopPaymentMethod extends ShopPaymentMethod {
  ...
  getRenderContext() {
    return {
      id: this.data.id,
      title: this.t(
        'payment_methods.shop_payment_methods.komoju.credit_card.title'
      ),
      value: this.getValue(),
      subfields_content: this.options.html_templates
        .komoju_credit_card_subfields_content,
      subfields_class: '',
      icon: 'generic',
      icon_description: this.t(
        'payment_methods.shop_payment_methods.komoju.credit_card.icon_description'
      ),
      komoju_credit_card_message_js: this.t(
        'payment_methods.shop_payment_methods.komoju.credit_card.komoju_credit_card_message_js'
      ),
      komoju_credit_card_message_no_js: this.t(
        'payment_methods.shop_payment_methods.komoju.credit_card.komoju_credit_card_message_no_js'
      )
    };
  }
}
